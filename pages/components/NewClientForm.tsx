                                ...
                                <div className="bg-white px-4 py-5 sm:p-6">
                                    <div className="grid grid-cols-6 gap-6">
                                        ...
                                        <div className="col-span-6 sm:col-span-3">
                                            ...
                                            <select id="sucursal" name="sucursal" className="mt-1 block w-full rounded-md border border-gray-600 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
